...
class TestLinkedList(unittest.TestCase):
    ...
    def test_quick_sort1(self) -> None:
        self.assertEqual(merge_sort(self.arr), [1, 2, 21, 23, 34, 34, 54, 55, 64, 67, 87, 98, 343, 345],
    ...
    #
    # def test_quick_sort_with_reversed1(self) -> None:
    ...
    #
    # def test_quick_sort_with_reversed2(self) -> None:
