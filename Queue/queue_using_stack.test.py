...
class TestLinkedList(unittest.TestCase):
    ...
    def test_dequeue(self):
        for x in self._arr:
            self._queue.enqueue(x)
        self._queue.dequeue()
        self.assertEqual(self._queue.get_queue(),[54, 64, 55, 34, 21, 87, 98, 345, 67, 34, 343, 2, 23],'values should be [1, 64, 55, 34, 21, 87, 98, 345, 67, 34, 343, 2')
        self._queue.enqueue(343)
        self.assertEqual(self._queue.get_queue(),[54, 64, 55, 34, 21, 87, 98, 345, 67, 34, 343, 2, 23, 343],'values should be [1, 64, 55, 34, 21, 87, 98, 345, 67, 34, 2, 343 ]')
    ...
    def test_peak(self):
        ...
        self._queue.enqueue(4)
        self._queue.enqueue(3)
        self.assertEqual(self._queue.peak(),1,'Validate peak method')
